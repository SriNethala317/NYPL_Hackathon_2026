    ...
    try {
      ...
      return records
        ...
        .map((record): BenefitProgram | undefined => {
          ...
          return {
            programId, programCode: field(record, 'program_code'), programName,
            category: field(record, 'program_category'), description: field(record, 'program_description'),
            officialSourceUrl: field(record, 'program_link', 'website_url', 'website'), applicationUrl: field(record, 'application_link', 'application_url'),
